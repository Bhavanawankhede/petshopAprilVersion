            ...
            <div className='tableContainerOrder'>
                ...
                <FormControl className="paymentSelect" >
                    ...
                    >
                        ...
                        <MenuItem value="pod" > <Button className="selectBtn">Pay on Delivery</Button></MenuItem>
                        <MenuItem value="paytm" ><Button className="selectBtn"> Buy With Paytm</Button></MenuItem>
                        <MenuItem value="gpay"  >
                            <GooglePayButton
                                buttonColor='white'
                                environment="TEST"
                                ...
                                buttonType='buy'
                            /></MenuItem>
                        <MenuItem value="phonepay"  > <Button className="selectBtn">Buy with PhonePay</Button></MenuItem>
                        <MenuItem value="other" ><Button className="selectBtn">Other UPI</Button></MenuItem>
                    </Select>
                </FormControl>
